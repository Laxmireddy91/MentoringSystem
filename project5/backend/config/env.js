...
const envSchema = z.object({
  ...
  JWT_SECRET: z.string().min(16, 'JWT_SECRET must be at least 16 chars').default('mentor_connect_super_secret_jwt_key_2026_production_ready'),
  JWT_EXPIRES_IN: z.string().default('1h'),
  JWT_REFRESH_SECRET: z.string().min(16, 'JWT_REFRESH_SECRET must be at least 16 chars').default('mentor_connect_refresh_secret_key_2026_secure'),
