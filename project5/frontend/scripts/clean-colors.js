// scripts/clean-colors.js
// Run with: `node scripts/clean-colors.js`
...
const rules = [
  ...
  // ==== Role accent (indigo, purple, teal, etc.) – map to role utilities ====
  // Primary role colour (used for buttons, active states)
  ...
  // Soft role background (tints, badges)
  ...
  // Purple decorative → use soft role colour as well
  ...
  // This is a simple heuristic: replace common bright hexes with corresponding vars
  { regex: /#ff0000|#f00|#FF0000/g, replace: 'var(--primary-color)' }, // red → role primary (fallback)
  { regex: /#00ff00|#0f0|#00FF00/g, replace: 'var(--status-success)' }, // green
  { regex: /#ffff00|#ff0|#FFFF00/g, replace: 'var(--status-warning)' }, // yellow
  { regex: /#0000ff|#00f|#0000FF/g, replace: 'var(--status-info)' }, // blue
];
